...
4.  Manage fields > Add a new text area field with unlimited values
5.  Enable ecomma commentary features for that text area field in the settings.
6.  Taxonomy: Add Vocabulary and enable it for the new content type.
7.  Taxonomy: Check Settings > Tags checkbox
8.  Site Configurations > Community tags: Enable new vocabulary
9.  New content type  > Workflow settings > Community tagging form:Select Block
(Go to content User Management > Permissions for step 10-13)
10. Community_tags: Enable "tag content" for authenticated and anonymous users.
(Enables unauthenticated users to see the tags, but not to tag.)
11. Community_tags: Enable "edit own tags" for authenticated.
12. Comment: Enable "access comments" for authenticated and anonymous users. 
(Enables unauthenticated users to see the comments, but not to comment.)
13. Comment_delete: Enable "delete own comments" for authenticated  users.


14. Site building > Pages > List:
...
15. Create a node of the new node typ. Just enter your text in new text field.
